...
def predictCOVID(imageToBeTested):
    ...
    label = ["You are likely infected by COVID-19. Please get tested and Quarantine Yourself", "Your X-Ray was Normal, if you still have symptoms do get tested."]
...
if __name__ == '__main__':
    ...
    app.run(debug=False)     # Enable Debugging for the error